...
export default function Home() {
  ...
  return (
    <div style={{ background: '#f8f4ee', minHeight: '100vh' }}>
      ...
      {menuOpen && (
        <>
          ...
          <div style={{
            ...
            {['Inicio', 'Catálogo', 'Contacto', 'Envíos', 'Nosotros'].map((item, i) => (
              <p key={item} onClick={() => setMenuOpen(false)} style={{
      ...
      {/* ── HERO ── */}
      <section style={{ padding: '48px 24px 32px', borderBottom: '1px solid #e0d8cc' }}>
      ...
      {/* ── CTA ── */}
      <section style={{ background: '#1a1a1a', padding: '48px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '20px' }}>
        <div>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ padding: '24px', borderTop: '1px solid #e0d8cc', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
